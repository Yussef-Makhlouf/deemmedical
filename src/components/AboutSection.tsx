        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              For over two decades, MedEquip Pro has been the preferred medical equipment supplier for hospitals, clinics, and diagnostic centers. We combine deep industry expertise with an unwavering commitment to quality and compliance.
            </p>
